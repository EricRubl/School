...
# IPsec pre-shared key and L2TP VPN credentials
YOUR_IPSEC_PSK=''
YOUR_USERNAME=''
YOUR_PASSWORD=''
...
# Check OS type to be Debian-like else abort
...
# Check if the default NIC is available and not wireless else abort
...
# Check for proper VPN credentials
...
L2TP_NET=${VPN_L2TP_NET:-'10.10.2.0/28'}
L2TP_LOCAL=${VPN_L2TP_LOCAL:-'10.10.2.1'}
L2TP_POOL=${VPN_L2TP_POOL:-'10.10.2.2-10.10.2.14'}
XAUTH_NET=${VPN_XAUTH_NET:-'10.10.3.0/28'}
XAUTH_POOL=${VPN_XAUTH_POOL:-'10.10.3.2-10.10.3.14'}
